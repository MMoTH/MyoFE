...
cd ../../../python_codes
singularity exec --cleanenv /home/mme250/fenics.img  mpiexec -np $SLURM_NTASKS  python MyoFE.py LV_sim /home/mme250/MyoFE/demos/HCM_paper/simulations_fibrous0.5_TS0.5_8core/fibrous_TS_kappa15_k1_10/sim_inputs/input_parameters.json
