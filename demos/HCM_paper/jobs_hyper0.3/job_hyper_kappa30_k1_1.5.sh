...
#SBATCH --job-name=LV_sim_jobs     # Job name
#SBATCH --ntasks=32
...
cd ../../../python_codes
singularity exec --cleanenv /home/mme250/fenics.img  mpiexec -np $SLURM_NTASKS  python MyoFE.py LV_sim /home/mme250/MYoFE/demos/HCM_paper/simulations_hyper0.3/hyper_kappa30_k1_1.5/sim_inputs/input_parameters.json
